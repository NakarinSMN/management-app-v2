            ...
            <form onSubmit={handlePasswordSubmit}>
              <div className="relative mb-8">
                <input
                  ...
                  placeholder="••••"
                  className={`w-full text-center text-4xl tracking-[0.4em] py-3 border-b-2 bg-transparent focus:outline-none transition-all duration-500 ${
                    error ? 'text-red-500 border-red-200' : 'text-gray-900 border-gray-100 focus:border-gray-900'
                  }`}
                />
                {error && (
